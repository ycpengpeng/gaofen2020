...
double blindPoints[4][10] =
        {
                ...
                {10.5 , 2.5, height   , 0, velocityX, 0, 0, 0, 0, 0},
                {10.5 , 2.5, height+2 , 0, velocityX, 0, 0, 0, 0, 0},
                {12.0 , 2.5, height+2 , 0, velocityX, 0, 0, 0, 0, 0},
                {12.0 , 2.0, height   , 0, velocityX, 0, 0, 0, 0, 0},
        };

double frontPoints[6][10] =
        {
                ///x,   y,   z,yaw,vx,vy,vz,ax,ay,az
                {2.5 - frontLoopDistance, -1  , height, 0, velocityX, 0, 0, 0, 0, 0},
                {5.2 - frontLoopDistance, -2.5, height, 0, velocityX, 0, 0, 0, 0, 0},
                {7.2 - frontLoopDistance, -1.5, height, 0, velocityX, 0, 0, 0, 0, 0},
                {9.5 - frontLoopDistance, 2.5 , height, 0, velocityX, 0, 0, 0, 0, 0},
                {13.5- frontLoopDistance, 2   , height, 0, velocityX, 0, 0, 0, 0, 0},
                {18  - frontLoopDistance, -2.8, height, 0, velocityX, 0, 0, 0, 0, 0},
...
double centerPoints[6][10] =
        {
                ///x, y, z, yaw, vx, vy, vz, ax, ay, az
                {2.5 + behindLoopDistance, -1   , height , 0, velocityX, 0, 0, 0, 0, 0},
                {5.2 + behindLoopDistance, -2.5 , height , 0, velocityX, 0, 0, 0, 0, 0},
                {7.2 + behindLoopDistance, -1.5 , height , 0, velocityX, 0, 0, 0, 0, 0},
                {9.5 + behindLoopDistance, 2.5  , height , 0, velocityX, 0, 0, 0, 0, 0},
                {13.5+ behindLoopDistance, 2    , height , 0, velocityX, 0, 0, 0, 0, 0},
                {18  + behindLoopDistance, -2.8 , height , 0, velocityX, 0, 0, 0, 0, 0},
        };
